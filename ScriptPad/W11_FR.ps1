...
Invoke-RestMethod https://raw.githubusercontent.com/t4ov/testosd/refs/heads/main/RenameFR.ps1 | Out-File -FilePath 'C:\Windows\Setup\Scripts\RenameFR.ps1' -Encoding ascii -Force
...
start /wait powershell.exe -NoL -ExecutionPolicy Bypass -F C:\Windows\Setup\Scripts\RenameFR.ps1
